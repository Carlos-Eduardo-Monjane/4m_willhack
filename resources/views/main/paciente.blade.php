              ...
              <div class="card">
                <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Agendas em espera</p>
              ...
              <div class="card">
                <div class="card-header p-3 pt-2">
                  <div class="icon icon-lg icon-shape bg-gradient-info shadow-info text-center border-radius-xl mt-n4 position-absolute">
                    <i class="material-icons opacity-10" translate="no">blur_on</i>
                  </div>
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Agendas confirmadas</p>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card">
                <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Agendas canceladas</p>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card">
                <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Total Agendas</p>
