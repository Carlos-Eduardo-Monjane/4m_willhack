            ...
            <div class="card card-plain h-100">
              ...
              <div class="card-body p-3">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Recompensa:</strong> &nbsp; {{Auth::user()->recompensa}}</li>
                  @endif
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="text" name="phone" autocomplete="off"  class="phone1 form-control">
                  </div>
                   <script>
