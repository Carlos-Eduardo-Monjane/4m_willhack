...
<section class="section" style="background-image: url('assets/img/Logo-Social-Media.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-size: fill;">
    ...
    <div class="page-header ">
        <div class="container rounded-lg ">
            <span class="mask rounded-lg bg-gradient-primary  opacity-6 border border-success" ></span>
          <div class="row">
    ...
    <div class="col-3 ">
        <p>.</p>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 bg-white">
              <div class="card card-plain">
                <div class="card-header card-body">
                  <h4 class="font-weight-bolder text-uppercase">Torne-se um profissional de sucesso!</h4>
                ...
                <div class="card-body">
                  ...
                  @enderror
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">Outro E-mail</label>
                      <input type="email" id="email" required name="email" value="{{ old('email') }}"  autocomplete="email"  class="form-control @error('email') is-invalid @enderror">
