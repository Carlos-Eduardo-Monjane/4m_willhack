  ...
  <div class="row">
        ...
        <div class="card-header pb-0 p-3">
          <div class="row">
            ...
            <div class="col-6 text-end">
              <a class="btn bg-gradient-dark mb-0" href="{{ url('cliente.pro.favorito.new') }}"><i class="material-icons text-sm" translate="no">add</i>&nbsp;&nbsp;Adicionar Profissional</a>
            </div>
    ...
    <div class="col-lg-12 mt-3">
      ...
      <div class="row">
        ...
        @php
$user = App\Profissional_Favorito::where('profissional_id',$item->pro_favorito->id)->get(); 
...
@endphp
      ...
      <div class="col-lg-4 mt-4 mb-3">
        ...
        <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1 " style="background-image: url('{{URL::asset('img/logo-ct-dark.png')}}');   background-repeat: no-repeat;
    background-size: 100% 100%;"> 
          ...
          <div class="card-body">
            ...
            <h6 class="mb-0 text-md">Recompensa</h6>
              <div class="mb-0 text-sm">
                ...
                <p class="text-sm mb-0 "><strong class="text-dark "><i class="material-icons text-sm my-auto me-1" translate="no">card_giftcard</i></strong> &nbsp;{{$item->pro_favorito->recompensa}}</p>
            ...
            <div class="text-center">
              <div class="d-flex text-center">
                <p class="me-5 ">
                  <a class="btn bg-gradient-danger mb-0" href="{{ url('cliente.pro.favorito.delete') }}/{{ $item->id }}"><i class="material-icons text-sm" translate="no">delete</i>&nbsp;&nbsp;Remover</a>
