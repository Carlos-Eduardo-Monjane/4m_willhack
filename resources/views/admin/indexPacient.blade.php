        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2" >
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <div class="row">
                        <div class="col-md-12">
                        <h6 class="text-white text-capitalize ps-3">{{ $user_type }}    
                            <button class="btn btn-info pull-right" onclick="store_new_paciente()">Novo paciente</button>
                        </h6>
                     </div>
                </div>
                </div>
                                            ...
                                            <tbody>
                                                @foreach ($lista as $item)
                                                    <tr>
                                                      ...
                                                      <td class="align-middle text-center">
                                                        <span
                                                            class="text-secondary text-xs font-weight-bold">{{ $item->cpf}}</span>
                                                    </td>
