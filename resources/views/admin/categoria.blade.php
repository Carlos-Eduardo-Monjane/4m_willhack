...
@endif           
                                        ...
                                        <div class="col-md-12 mb-lg-0 mb-4">
                                            <div class="card px-0 pb-2">
                                                ...
                                                <div class="table-responsive p-0 card-body">
                                                    <table id="datatable-cat" class="table align-items-center mb-0">
                                                        <thead>
                                                            <tr>
                                                                <th
                   ...
                   <!-- Modal cadastrar produto-->
@if ($msg == 'modal_store_subcategoria')
    ...
    <div class="modal fade" id="modalPush" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-notify modal-info" role="document">
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-header d-flex justify-content-center">
                    <h5 class="heading">
                      Registro de nova sub-categoria
                    </h5>
                </div>
                ...
                <div class="modal-body">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Descrição da sub-categoria </label>
                    <input type="text" name="describe" autocomplete="off"  class="form-control">
                  </div>
                     <p class="">Categoria</p>
                <div class="input-group input-group-outline mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-lg-0 mb-4">
                                            <div class="card px-0 pb-2">
                                                ...
                                                <hr>
                                                <div class="table-responsive p-0 card-body">
                                                    <table id="datatable-subcat" class="table align-items-center mb-0">
                                                        <thead>
                                                            <tr>
                                                                <th
                                                                    class="text-center  text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
