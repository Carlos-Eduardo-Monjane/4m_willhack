                    ...
                    <div class="card-header pb-0 px-3">
                      <div class="row">
                        ...
                        <div class="col-6 text-end">
                          <a href="{{ url('pro.oferta.model_store_index') }}" class="btn bg-gradient-dark mb-0"><i class="material-icons text-sm" translate="no">add</i>&nbsp;&nbsp;Nova Oferta </a>
                        </div>
                      </div>
                    </div>
                    <hr>
...
<script>
  //datatable
    $(document).ready( function () {
        $('#datatable-ofertas').DataTable();
    } );

</script>
                    <div class="table-responsive p-0 card-body">
                      <table id="datatable-ofertas" class="table align-items-center mb-0">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ url('produtos-editar-produto') }}?shop_id={{Auth::user()->shop_id}}&idproduto={{$item->id}}" class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i class="material-icons text-sm me-2" translate="no" title="Editar">edit</i></a>
                              <a  href="{{ url('produtos-deletar-produto') }}?shop_id={{Auth::user()->shop_id}}&idproduto={{$item->id}}" class="btn btn-link text-danger text-gradient px-3 mb-0" ><i class="material-icons text-sm me-2" translate="no" title="Apagar">delete</i></a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
              ...
              <div class="card h-100">
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a href="{{ url('produtos-cadatrar-categoria') }}?shop_id={{Auth::user()->shop_id}}" class="btn btn-outline-dark btn-sm mb-0"><i class="material-icons text-sm" translate="no">add</i>&nbsp;&nbsp;Nova </a>
                    </div>
                  </div>
                  <hr>
                </div>
                    ...
                    @foreach($categorias as $item)
                      <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                        ...
                        <div class="d-flex align-items-center text-sm">
                          ...
                          <a  href="{{ url('produtos-deletar-categoria') }}?shop_id={{Auth::user()->shop_id}}&idcategoria={{$item->id}}" class="btn btn-link text-danger text-gradient px-3 mb-0" ><i class="material-icons text-sm me-2" translate="no" title="Apagar">delete</i></a>
                        </div>
                      </li>
                    @endforeach
                  </ul>
                            ...
                            <div class="card px-0 pb-2">
                              <div class="card-header pb-0 px-3">
                                <div class="row">
                                  ...
                                  <div class="col-6 text-end">
                                    @if (count($ofertas) == 0)
                                    <a href="{{ url('pro.oferta.model_store') }}" class="btn bg-gradient-dark mb-0"><i class="material-icons text-sm" translate="no">add</i>&nbsp;&nbsp;Nova Oferta </a>
                                    @endif
                                 </div>
                                </div>
                              </div>
                                ...
                                <table id="datatable-produtos" class="table align-items-center mb-0">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td class="align-middle text-center">
                                        <a href="{{ url('pro.oferta.model_edit') }}/{{$item->id}}" class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i class="material-icons text-sm me-2" translate="no" title="Editar">edit</i></a>
                                        <a  href="{{ url('pro.oferta.model_delete') }}/{{$item->id}}" class="btn btn-link text-danger text-gradient px-3 mb-0" ><i class="material-icons text-sm me-2" translate="no" title="Apagar">delete</i></a>
                                      </td>
                                    </tr>
                                    @endforeach
                                  </tbody>
