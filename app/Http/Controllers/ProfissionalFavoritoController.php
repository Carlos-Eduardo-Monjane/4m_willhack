...
class ProfissionalFavoritoController extends Controller
{
        ...
        public function add_new_pro_index() {
          ...
          $fav_pro_already_added = Profissional_Favorito::where('cliente_id', Auth::user()->id)->get();

//   $fav_pro_already_added_ID = Profissional_Favorito::where('cliente_id', Auth::user()->id)->get('id');
  $arrayID  = [];

  foreach($fav_pro_already_added as $id){
      array_push($arrayID, $id->profissional_id);
  }
...
// echo 'Meus: '.$fav_pro_already_added;
// echo '<br>';
// echo 'Meus ID: '.$fav_pro_already_added_ID;
// echo '<br>';
// // echo 'Meus ID Only: '.$arrayID;
// print_r($arrayID);
// echo '<br>';
// echo 'Todos: '.$fav_pro;
// echo '<br>';
// echo 'Filtros: '.$fav_pro_already_added;
// echo '<br>';

// foreach ($fav_pro as $user){
//   echo $user;
// echo '<br>'; 
// echo '<hr/>'; 
// echo '<br>'; 
// }
            ...
            $fav_pro_count = $fav_pro->count();
               ...
               return view('cliente.favorito_pro_novo')->with(["fav_pro_already_added" => $fav_pro_already_added, "profissionais"=>$fav_pro, "fav_pro_count"=>$fav_pro_count, 'msg' => 'add_new_pro']);
           }
