...
class OfertaClienteController extends Controller
{
        ...
        public function my_pro_index(){
            ...
            ->with('subspecialty')->latest()->get();
            $fav_pro_count = $fav_pro->count();
            return view('cliente.oferta')->with(["profissionais"=>$fav_pro, "fav_pro_count"=>$fav_pro_count, 'msg' => 'my_pro']);
           }
           ...
           public function my_pro_delete(Request $request){
            ...
            $fav_pro_count = $fav_pro->count();
            return view('cliente.oferta')->with(["profissionais"=>$fav_pro, "fav_pro_count"=>$fav_pro_count, 'msg' => 'my_pro_success']);
           }
           ...
           public function add_new_pro_index(){
            ...
            return view('cliente.oferta')->with(["profissionais"=>$fav_pro, "fav_pro_count"=>$fav_pro_count, 'msg' => 'add_new_pro']);
           }
           ...
           public function model_store_on_fav(Request $request){
            ...
            return view('cliente.oferta')->with(["profissional_invest"=>$profissional_invest, "profissionais"=>$fav_pro, "fav_pro_count"=>$fav_pro_count, 'msg' => 'modal_store_inv']);
           ...
           public function add_new_pro_store(Request $request){
            ...
            if($fav_validate){ 
                ...
                $fav_pro_count = $fav_pro->count();
                return view('cliente.oferta')->with(["profissionais"=>$fav_pro, "fav_pro_count"=>$fav_pro_count , 'msg' => 'add_new_pro_error']);
